...
public class AssignmentScriptswithTestNG extends TestBase {
	...
	// land on home page then click on forgot message then enter email and clik on
	// button.
	@Test(priority = 1)
	public void enterEmail() throws InterruptedException {
		driver.findElement(By.xpath("//*[@id='content']/ul/li[20]/a")).click(); // find forgot password link and click
																				// on it
	...
	// land on home page and click on forgot page then find the title of navigated
	// page and verify it.
	@Test(priority = 2)
	public void verifyTitle() throws InterruptedException {
		...
		Assert.assertEquals(actualTitle, expectedTitle); // It'll check if the actual title is equal to expected title
															// and it'll return boolean(true or false).
		System.out.println("Title is verified");
	}

	// land on home page then click on forgot password. enter email then click on
	// button. after that verify the error message.
	@Test(priority = 3)
